...
def capture_screen_interactive(output_path="/tmp/screenchat_capture.png"):
    """
    ...
    bus.connect("org.freedesktop.portal.Desktop", request_path, "org.freedesktop.portal.Request", "Response", listener.on_response)
